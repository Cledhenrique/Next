...
INSERT INTO artists (nome, country, genre)
...
SELECT title FROM songs WHERE artist = ("Queen"); #Etapa 1

SELECT nome FROM artists WHERE genre = ("Pop") #Etapa 2
